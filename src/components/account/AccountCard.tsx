...
export function AccountCard({ title, subtitle, icon, action, children, className }: AccountCardProps) {
  return <section className={cn("rounded-2xl border border-[color-mix(in_srgb,var(--line)_92%,var(--accent))] bg-[var(--surface-raised)] p-4 text-[var(--ink)] shadow-[0_7px_22px_rgba(0,0,0,0.18)]", className)}>
