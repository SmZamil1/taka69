  ...
  return (
    <div className="-mx-3 -mt-3 min-h-[calc(100vh-5rem)] bg-[#eef5fb] px-3 pb-24 pt-3 text-[#173251]">
      <div className="mx-auto max-w-lg space-y-3">
        ...
        <div className="grid grid-cols-1 gap-2 min-[400px]:grid-cols-3"><div className="rounded-xl border border-[#dce8f2] bg-[#f8fbfe] p-3 text-center shadow-sm"><div className="text-xl font-black text-[#d4871b]">{stats.directReferrals.length}</div><div className="text-[10px] text-[#6d879f]">{t("Referrals", "রেফারেল")}</div></div><div className="rounded-xl border border-[#dce8f2] bg-[#f8fbfe] p-3 text-center shadow-sm"><div className="text-xl font-black text-[#2675bd]">{stats.byLevel.reduce((s, l) => s + l.count, 0)}</div><div className="text-[10px] text-[#6d879f]">{t("Total team", "মোট টিম")}</div></div><div className="rounded-xl border border-[#dce8f2] bg-[#f8fbfe] p-3 text-center shadow-sm"><div className="text-xl font-black text-[#2675bd]">{stats.byLevel.length}</div><div className="text-[10px] text-[#6d879f]">{t("Levels", "লেভেল")}</div></div></div>
